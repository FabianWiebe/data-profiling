...
public class SuperFD extends SuperFDAlgorithm 				// Separating the algorithm implementation and the Metanome interface implementation is good practice
	...
	public ArrayList<ConfigurationRequirement<?>> getConfigurationRequirements() { // Tells Metanome which and how many parameters the algorithm needs
		...
		conf.add(new ConfigurationRequirementRelationalInput(SuperFD.Identifier.INPUT_GENERATOR.name()));
	...
	public void setStringConfigurationValue(String identifier, String... values) throws AlgorithmConfigurationException {
		if (SuperFD.Identifier.SOME_STRING_PARAMETER.name().equals(identifier))
		{
	...
	public void setIntegerConfigurationValue(String identifier, Integer... values) throws AlgorithmConfigurationException {
		if (SuperFD.Identifier.SOME_INTEGER_PARAMETER.name().equals(identifier))
		{
	...
	public void setBooleanConfigurationValue(String identifier, Boolean... values) throws AlgorithmConfigurationException {
		if (SuperFD.Identifier.SOME_BOOLEAN_PARAMETER.name().equals(identifier))
		{
	...
	public void setRelationalInputConfigurationValue(String identifier, RelationalInputGenerator... values) throws AlgorithmConfigurationException {
		if (!SuperFD.Identifier.INPUT_GENERATOR.name().equals(identifier))
			this.handleUnknownConfiguration(identifier, values);
