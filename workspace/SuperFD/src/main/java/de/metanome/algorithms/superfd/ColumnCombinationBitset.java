...
public class ColumnCombinationBitset implements Comparable<ColumnCombinationBitset> {
  ...
  public ColumnCombinationBitset removeLastColumn() {

    int lastSetBitIndex = bitset.prevSetBit(bitset.length());
    size--;
    bitset.clear(lastSetBitIndex);

    return this;
  }
  
  public ColumnCombinationBitset newWithoutLastColumn() {
    return new ColumnCombinationBitset(this).removeLastColumn();
  }
